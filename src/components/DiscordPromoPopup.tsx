  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div
            className={`rounded-md border shadow-2xl p-4 sm:p-5 overflow-hidden relative group transition-colors duration-200 ${
              isDark
          ...
          >
            ...
            <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-[#5865F2] via-blue-400 to-[#5865F2]" />

            {/* Close Button */}
            <button
              onClick={() => handleDismiss(false)}
              className={`absolute top-3.5 right-3.5 p-1.5 rounded-xs transition-colors cursor-pointer ${
                isDark
            ...
            <div className="flex items-start gap-3.5 pt-1">
              ...
              <div className="w-11 h-11 rounded-xs bg-[#5865F2] flex items-center justify-center shrink-0 shadow-md shadow-[#5865F2]/25 relative">
                ...
                <span
                  className={`absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-emerald-500 border-2 rounded-xs animate-pulse ${
              ...
              <div className="flex-1 pr-4">
                ...
                <div className="flex flex-wrap gap-1.5 mb-3.5">
                  <div
                    className={`inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-xs text-[11px] font-thai border ${
                      isDark
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={handleJoin}
                    className="flex-1 inline-flex items-center justify-center gap-1.5 bg-[#5865F2] hover:bg-[#4752c4] active:scale-[0.98] text-white font-thai text-[12.5px] font-medium py-2 px-3.5 rounded shadow-sm transition-all cursor-pointer"
                  >
                  ...
                  <button
                    onClick={() => handleDismiss(false)}
                    className={`px-3 py-2 font-thai text-[12px] rounded transition-colors cursor-pointer ${
                      isDark
                ...
                <div className="mt-2.5 text-right">
                  <button
                    ...
                    className={`text-[11px] font-thai transition-colors cursor-pointer rounded-xs px-2 py-0.5 ${
