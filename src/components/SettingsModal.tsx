...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-xs select-none">
      <div 
        className={`w-full max-w-[480px] border rounded-md shadow-2xl flex flex-col overflow-hidden transition-all ${
          isDark
      ...
      >
        ...
        <div className={`flex items-center justify-between px-6 py-4.5 border-b ${
          ...
          <div className="flex items-center gap-2.5">
            <div className={`w-8 h-8 rounded-xs flex items-center justify-center border shadow-2xs ${
          ...
          <button
            type="button"
            onClick={onClose}
            className={`p-1.5 rounded-xs transition-colors cursor-pointer border shadow-2xs ${
              isDark
          ...
          <div className="space-y-2 pt-2 border-t border-zinc-200/60 dark:border-zinc-800/60">
            ...
            {!confirmDelete ? (
              <button
                ...
                className={`w-full py-2.5 px-4 rounded flex items-center justify-center gap-2 transition-all cursor-pointer text-sm font-medium border shadow-2xs ${
                  isDark
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2.5 bg-red-600 hover:bg-red-700 text-white rounded flex items-center justify-center transition-all cursor-pointer text-sm font-medium shadow-xs"
                >
                  ยืนยันการล้างข้อมูล
                </button>
                <button
                  ...
                  className={`px-4 py-2.5 rounded border cursor-pointer text-sm font-medium transition-colors ${
                    isDark
