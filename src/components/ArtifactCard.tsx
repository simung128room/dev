  ...
  if (isStreaming) {
    return (
      <div
        ...
        className={`my-3 w-full max-w-xl group cursor-pointer select-none rounded p-3 sm:p-3.5 flex items-center justify-between gap-3.5 text-left transition-all duration-200 border ${
          isDark
      ...
      >
        ...
        <div
          className={`w-11 h-11 sm:w-12 sm:h-12 shrink-0 rounded-sm flex items-center justify-center border shadow-xs transition-all ${
            isDark
        ...
        <div className="min-w-0 flex-1 space-y-1.5">
          {artifact.title ? (
            <div className="flex items-center gap-2">
              ...
              <span className="w-1.5 h-1.5 rounded-xs bg-zinc-400 animate-pulse shrink-0" />
            </div>
          ) : (
            <div
              className={`h-4 rounded-xs w-36 animate-pulse ${
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div
            className={`px-3.5 py-1.5 rounded border text-xs sm:text-[13px] font-normal transition-all shadow-2xs select-none ${
              isDark
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3.5 min-w-0 flex-1">
        ...
        <div
          className={`w-11 h-11 sm:w-12 sm:h-12 shrink-0 rounded-sm flex items-center justify-center border shadow-xs transition-colors ${
            isDark
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          className={`inline-flex items-center justify-center px-3.5 py-1.5 rounded border text-xs sm:text-[13px] font-normal transition-all active:scale-95 cursor-pointer shadow-2xs ${
            isDark
