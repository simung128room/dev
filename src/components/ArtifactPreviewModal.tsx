...
<body>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="relative w-full max-w-5xl h-[85vh] bg-zinc-950 border border-zinc-800 rounded-md shadow-2xl flex flex-col overflow-hidden">
        {/* Header Bar */}
        <div className="flex items-center justify-between px-5 py-3.5 bg-zinc-900/90 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <span className="p-2 rounded-xs bg-zinc-800 border border-zinc-700 text-zinc-300">
              <Code className="w-4 h-4" />
            </span>
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-sm font-semibold text-zinc-100 font-sans">{title}</h3>
                <span className="inline-flex items-center gap-1 text-[10px] px-2 py-0.5 rounded-xs bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 font-mono">
          ...
          <div className="flex items-center gap-2">
            {/* Device Toggle */}
            <div className="flex items-center p-0.5 bg-zinc-950 rounded-xs border border-zinc-800">
              <button
                type="button"
            ...
            <button
              ...
              className="p-2 rounded-xs border border-transparent hover:border-zinc-700 text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors cursor-pointer"
        ...
        <div className="flex-1 bg-[#09090b] p-4 flex items-center justify-center overflow-auto">
          <div
            className={`h-full transition-all duration-300 bg-zinc-950 rounded-xs border border-zinc-800 overflow-hidden shadow-inner ${
