...
export const CodeBlock: React.FC<CodeBlockProps> = ({
  ...
  return (
    <div className="my-4 overflow-hidden rounded bg-[#0d0d12] transition-all border border-zinc-800 shadow-md">
      {/* Code Header Bar */}
      <div className="flex flex-wrap items-center justify-between gap-2 px-3.5 py-2.5 bg-zinc-900/90 border-b border-zinc-800 select-none">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-sm bg-zinc-800/80 border border-zinc-700/80 text-[12px] font-mono text-zinc-200">
            ...
            {isEditingFilename ? (
              <input
                ...
                autoFocus
                className="bg-black text-white px-1.5 py-0.5 rounded-sm border border-zinc-600 font-mono text-xs focus:outline-none w-28 sm:w-36"
              />
            ) : (
              <button
                type="button"
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          {isExecutable && (
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1 rounded bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 hover:text-emerald-300 transition-all text-xs font-mono font-medium cursor-pointer active:scale-95"
            >
          ...
          {isHtmlVisual && (
            <button
              ...
              title="พรีวิว UI สด"
              className="flex items-center gap-1 px-2.5 py-1 rounded bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-zinc-200 hover:text-white transition-all text-xs font-mono font-medium cursor-pointer active:scale-95"
            >
          ...
          <button
            ...
            className="p-1.5 rounded text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800 border border-transparent hover:border-zinc-700 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 py-1 rounded text-zinc-200 hover:text-white bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 hover:border-zinc-600 transition-colors cursor-pointer text-xs font-mono"
          >
      ...
      {showConsole && execResult && (
        <div className="bg-black/90 border-t border-zinc-800 p-3.5 font-mono text-xs">
          <div className="flex items-center justify-between pb-2 mb-2 border-b border-zinc-800">
            ...
            {!execResult.success && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1 rounded bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 text-white text-xs font-mono font-medium transition-all cursor-pointer active:scale-95"
              >
          ...
          {execResult.error ? (
            <div className="text-red-400 bg-red-950/40 p-3 rounded border border-red-800/80 whitespace-pre-wrap flex items-start gap-2">
      ...
      {showRunConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fade-in">
          <div className="bg-zinc-950 border border-zinc-800 rounded-md p-5 max-w-md w-full shadow-2xl space-y-4">
            <div className="flex items-start gap-3">
              <div className="p-2.5 rounded bg-amber-500/10 border border-amber-500/30 text-amber-400 shrink-0">
            ...
            <div className="px-3.5 py-2.5 rounded bg-zinc-900 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center justify-between">
            ...
            <div className="flex items-center justify-end gap-2 pt-2">
              <button
                ...
                className="px-3.5 py-1.5 rounded text-xs font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors cursor-pointer"
              >
                ยกเลิก
              </button>
              <button
                onClick={handleConfirmAndRun}
                className="px-4 py-2 rounded text-xs font-semibold text-black bg-white hover:bg-zinc-200 transition-all active:scale-95 cursor-pointer shadow-xs"
              >
