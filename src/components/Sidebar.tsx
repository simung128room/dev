...
export const Sidebar: React.FC<SidebarProps> = ({
          ...
          {groupSessions.map((s) => {
            ...
            return (
              <div
                ...
                className={`group px-3.5 py-2 text-[13.5px] flex items-center justify-between transition-all cursor-pointer rounded-full ${
                  isActive
                    ? isDark
                      ? "bg-[#282a2c] text-white border border-[#3c4043]/50 font-medium shadow-xs"
              ...
              >
                <div className="flex items-center min-w-0 pr-2 gap-2 flex-1">
                  {isPinned && (
                    <Pin className={`w-3 h-3 shrink-0 ${
                      isDark ? "text-blue-400 fill-blue-400" : "text-blue-600 fill-blue-600"
                    }`} />
                  )}
                ...
                <div className="flex items-center gap-1 shrink-0 opacity-40 group-hover:opacity-100 transition-opacity">
                  ...
                  >
                    <Pin className={`w-3.5 h-3.5 ${isPinned ? (isDark ? "fill-blue-400 text-blue-400" : "fill-blue-600 text-blue-600") : ""}`} />
                  </button>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
  ...
  return (
    <>
      ...
      >
        {/* Top Header: DEV Logo + Close Button */}
        ...
        <div className="px-4 pt-3.5 pb-2">
          <button
            ...
            className="font-inter w-full h-10 active:scale-[0.98] text-[13.5px] font-medium tracking-normal rounded-full flex items-center justify-center transition-all cursor-pointer shadow-md bg-[#282a2c] hover:bg-[#333537] text-white border border-[#3c4043]/50"
          >
            <span>แชทใหม่</span>
          </button>
        </div>
        ...
        <div className={`px-4 py-3 mt-auto border-t space-y-1.5 transition-colors ${
          ...
          <a
            ...
            className={`font-inter flex items-center gap-2.5 px-3 py-2 border rounded text-[13px] transition-all cursor-pointer w-full text-left group ${
              currentTheme.isDark
          ...
          >
            ...
            <span className="text-[10px] bg-[#5865F2] text-white px-1.5 py-0.5 rounded-xs font-sans font-bold">
              JOIN
            </span>
          </a>
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-1.5 border rounded text-[11.5px] transition-all cursor-pointer w-full text-left select-none ${
              currentTheme.isDark
          ...
          >
            ...
            <span className="text-[9.5px] px-1.5 py-0.2 rounded-xs font-bold uppercase tracking-wider bg-emerald-500/15 text-emerald-600 dark:text-emerald-400">
              Active
            </span>
          </button>
          ...
          <button
            ...
            className={`font-inter flex items-center gap-2.5 px-3 py-2 border rounded text-[13px] transition-all cursor-pointer w-full text-left shadow-2xs ${
              currentTheme.isDark
